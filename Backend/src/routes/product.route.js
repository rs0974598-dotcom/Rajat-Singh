...
import { addProductVariants, createProduct, getAllpProducts, getAllProduct, getAllProductDetails,  } from "../controller/product.controller.js";
...
// router.get("/:productId/varaints",authenticateSeller,addProductVariants)
