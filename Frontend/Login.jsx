      ...
      <div className="flex flex-1 items-center justify-center overflow-y-auto px-6 py-10">
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-2xl border-[1.5px] border-gray-200 bg-white py-3.5 text-sm font-medium text-gray-700 transition-all hover:border-gray-300 hover:bg-gray-50 active:scale-[0.983]"
            >
              <svg width="18" height="18" viewBox="0 0 48 48">
                ...
                <path fill="#4CAF50" d="M24 44c5.2 0 9.9-1.9 13.5-5l-6.2-5.2C29.4 35.6 26.8 36.5 24 36.5c-5.2 0-9.6-3.5-11.2-8.3l-6.5 5C9.5 39.5 16.3 44 24 44z"/>
                <path fill="#1976D2" d="M43.6 20H24v8h11.3c-.8 2.3-2.3 4.3-4.3 5.8l6.2 5.2C41 35.7 44 30.3 44 24c0-1.3-.1-2.7-.4-4z"/>
              </svg>
