          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="name"
                required
                className="w-full rounded-2xl border-[1.5px] border-transparent bg-gray-50 px-4 py-3.5 text-sm text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-300 hover:border-gray-200 focus:border-black focus:bg-white"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-2xl border-[1.5px] border-transparent bg-gray-50 px-4 py-3.5 pr-12 text-sm text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-300 hover:border-gray-200 focus:border-black focus:bg-white"
                />
                <button
                  type="button"
            ...
            >
              {/* checkbox box */}
              <div
                className={`mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-md border-2 transition-all duration-150 ${
                  form.isSeller
            ...
            <button
              type="submit"
              className="w-full rounded-2xl bg-black py-4 text-sm font-semibold tracking-wide text-white transition-all duration-150 hover:bg-gray-900 active:scale-[0.983]"
            >
              Create Account →
            </button>
